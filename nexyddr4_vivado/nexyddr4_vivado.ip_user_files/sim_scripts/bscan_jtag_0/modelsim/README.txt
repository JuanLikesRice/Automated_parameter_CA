...
#
# Generated by export_simulation on Sun Oct 29 00:36:47 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './bscan_jtag_0.sh' script.

./bscan_jtag_0.sh -reset_run
...
./bscan_jtag_0.sh -noclean_files

For more information on the script, please type './bscan_jtag_0.sh -help'.
