...
HD_PWD='C:/juwan_projects/nexyddr4_working_ca_v1/nexyddr4_working_ca_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_module_fpga.tcl
