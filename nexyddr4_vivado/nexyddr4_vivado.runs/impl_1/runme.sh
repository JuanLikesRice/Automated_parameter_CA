...
HD_PWD='C:/juwan_projects/nexyddr4_working_ca_v1/nexyddr4_working_ca_v1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_module_fpga.tcl -notrace
