...
HD_PWD='C:/juwan_projects/nexy4ddr_CA/nexy4ddr_CA.runs/bscan_jtag_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bscan_jtag_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bscan_jtag_0.tcl
